...
module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      h1: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      h2: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      h3: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      h4: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      h5: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      h6: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      subtitle1: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      subtitle2: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      body1: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      body2: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      button: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      caption: ["MaanyMedium", "ui-sans-serif", "system-ui"],
      overline: ["MaanyMedium", "ui-sans-serif", "system-ui"],
    },
    fontWeight: {
